...
<div class="contact-form">
    ...
    <form class="form" action="/confirm" method="post" novalidate>
        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--radio">
                    <div>
                        <input type="radio" name="gender" id="gender1" value="1" {{ old('gender', request('gender')) == 1 ? 'checked' : '' }}>
                        <label for="gender1">男性</label>
                    </div>
                    <div>
                        <input type="radio" name="gender" id="gender2" value="2" {{ old('gender', request('gender')) == 2 ? 'checked' : '' }}>
                        <label for="gender2">女性</label>
                    </div>
                    <div>
                        <input type="radio" name="gender" id="gender3" value="3" {{ old('gender', request('gender')) == 3 ? 'checked' : '' }}>
        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--texts">
                    <input type="tel" name="telone" placeholder="080" value="{{ old('telone', request('telone')) }}" />
                    <span>-</span>
                    <input type="tel" name="teltwo" placeholder="1234" value="{{ old('teltwo', request('teltwo')) }}" />
                    <span>-</span>
        ...
        <div class="form__button">
            <button class="button form__button-submit" type="submit">確認画面</button>
        </div>
    </form>
</div>
@endsection